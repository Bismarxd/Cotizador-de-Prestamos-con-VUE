<script setup>
  ...
  //revisa la cantidad cada que cambie
...
<template>
  <div class="my-20 max-w-lg mx-auto bg-white shadow p-10">
    ...
    <div class="my-5">
      ...
      <select 
        class="w-full p-2 bg-white border border-gray-300 rounded-lg text-center text-xl font-bold text-gray-600 mt-5"
        :value="meses"
    ...
    <p v-else class="text-center text-green-900 text-xl font-bold">Elige una cantidad y un plazo a pagar</p>
